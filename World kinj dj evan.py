...
\033[1;37m   
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Dj Evan
\033[1;37m Facebook:            Dj Evan
\033[1;37m Github  :            dj Evan123
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('https://wa.me/qr/GW5BL3QMDAHCP1)
        pass
    elif select =='F':
        os.system('https://www.facebook.com/profile.php?id=100086216861789&mibextid=ZbWKwL/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
